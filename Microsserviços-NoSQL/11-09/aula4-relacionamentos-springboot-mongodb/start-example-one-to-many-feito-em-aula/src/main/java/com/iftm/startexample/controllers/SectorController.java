...
public class SectorController {
    ...
    @PostMapping("/sector/id/{sectorId}/add-employee/id/{employeeId}")
    public ResponseEntity<SectorDTO>
        addEmployeeInSectorById(@PathVariable("sectorId") ObjectId sectorId,
                                @PathVariable("employeeId") ObjectId employeeId) {
        return service.addEmployeById(sectorId, employeeId);
    }
